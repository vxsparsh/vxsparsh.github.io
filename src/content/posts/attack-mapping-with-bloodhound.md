...
description: 'Learn about bloodhound, ingestors, its installation and their usage and mapping attack paths with bloodhound.'
image: ''
...
```bash
alias bloodhound="docker compose -f /home/kali/.config/bloodhound/docker-compose.yml up -d"
